...
\newcommand{\contactCompany}{L3 Communications}
...
\newcommand{\position}{test development engineer }%TRAILING SPACE neeeded otherwise it butts up against the next word
