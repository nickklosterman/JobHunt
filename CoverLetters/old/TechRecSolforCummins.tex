...
\newcommand{\contactCompany}{Technical Recruiting Solutions}
\newcommand{\contactStreetAddress}{1305 Cumberland Avenue, Suite 100}
\newcommand{\contactCityStateZip}{West Lafayette, IN 47906 }
\newcommand{\position}{electrical systems engineer }%TRAILING SPACE neeeded otherwise it butts up against the next word
