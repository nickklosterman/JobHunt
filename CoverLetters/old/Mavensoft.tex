...
\newcommand{\contactCompany}{Mavensoft Tech}
...
\newcommand{\position}{power validation engineer }%TRAILING SPACE neeeded otherwise it butts up against the next word
\newcommand{\jobpostingsource}{Job.com} %Monster.com                                                                                                                                                           
