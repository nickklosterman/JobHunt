...
\begin{itemize}
Documentation of Remoting : had to figure out what Mike did and then create workign example for Quick Start Guide
Wrote Group Folder Module : Module provides slide out menu of available panels to load into main window.
...
-> context menu addition for grid ex.
