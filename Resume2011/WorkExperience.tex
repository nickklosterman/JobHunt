...
\else
\citem{Software Engineer}, Intelligrated Systems LLC, August 2012 - Present
\fi 
...
\item Developed panel Front End design (CSS/LESS \& HTML5) and Back End logic adhering to MVVM pattern utilizing Kendo UI. %By itself this fragment doesn't tell anyone wha tyou did. Itmust accompany another bullet point. %Should I split this into two separate bullets? or keep it succinct and not add items that could be perceived as fluff. short and sweet.
...
\item Initiated training sessions for new members to javascript team. Through these training sessions I helped educate team members on the intricacies of the asynchronous nature of the javascript language.%helped guide n00bz through the gotchas of our framework and the peculiarities to the javascript language

%\item Initiated training sessions for new members to javascript team. Session goals are to speed up the process of familiarization with javascript and our framework and transition from other programming languages. %helped guide n00bz through the gotchas of our framework and the peculiarities to the javascript language

%\item Live tested software at customer site on Ran production level 
...
% \item Configured open source jsdoc-toolkit to produce documentation from source code. %the following item kinda covers this one
\item Modified in house javascript preprocessor written in C\# source code preprocessor to work with jsdoc-toolkit. %this is laughable. its not really an accomplishment as much as a sign that the place I worked at is fucked up. -->make it show that you can interpret and hack C# code
% wow this is lame. \item Created demonstration panel of available widgets to show capabilities to internal Intelligrated customers. 
%\item Customers were internal teams, provided customer support

\item Performed weekly SVN merges of code branch with Trunk. %capitalize Trunk? what does weekly merges entail? What competency/trust does it speak about?
...
\else
\citem{Research  Assistant}, Purdue University, West Lafayette, IN  August 2007 - July 2010 
\fi
