...
\item Initiated training sessions for new members to javascript team. Through these training sessions I helped educate others on the gotchas of the asynchronous nature of the javascript language.%helped guide n00bz through the gotchas of our framework and the peculiarities to the javascript language
...
\item Modified C\# source code preprocessor to work with jsdoc-toolkit. %this is laughable. its not really an accomplishment as much as a sign that the place I worked at is fucked up. -->make it show that you can interpret and hack C# code
