...
%\end{itemize}
  ...
  \citem {Contributed to node-twitter package 2014}
  \begin{itemize}
    \ifWebLinks
...
\item Node.js app for viewing stock data from onlin top 50 lists
  ...
  \ifWebLinks
  \citem { Data stored in SQLite and displayed using \href{http://omnipotent.net/jquery.sparkline/}{jQuery Sparklines}

\else
\citem {Data stored in SQLite and displayed using jQuery Sparklines }
\fi
